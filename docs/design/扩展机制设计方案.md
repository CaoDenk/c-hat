...
extension string {
    ...
    func substring(long start, long end) -> string { /* 实现 */ }
    func contains(string sub) -> bool { /* 实现 */ }
    func starts_with(string prefix) -> bool { /* 实现 */ }
    func ends_with(string suffix) -> bool { /* 实现 */ }
}
```
